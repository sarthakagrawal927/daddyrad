...
Status: four public releases and isolated prior-build installed-app acceptance verified · protected manual publication verified end to end 2026-09-26 · [tracking issue](https://github.com/sass-maker/saas-maker/issues/139)

Manual publication follow-on · 2026-09-26: [shared tooling #148](https://github.com/sass-maker/saas-maker/pull/148), [StorageDaddy #45](https://github.com/sarthakagrawal927/storagedaddy/pull/45), [PerformanceDaddy #11](https://github.com/sarthakagrawal927/performancedaddy/pull/11), [BrowserDaddy #15](https://github.com/sarthakagrawal927/browserdaddy/pull/15), and [ContextDaddy #6](https://github.com/sarthakagrawal927/contextdaddy/pull/6) are merged. The four `main` candidate workflows passed. The manual jobs select an exact current-`main` tag, sign and notarize in the protected environment, deploy the app-owned Worker, and compare its live download and feed bytes with the qualified artifact before recording publication. StorageDaddy build 110, PerformanceDaddy build 8, BrowserDaddy build 9, and ContextDaddy build 5 completed this full path. Ordinary pushes remain candidate CI only. The receipts are below.
...
## Manual publication record · 2026-09-26

All four protected `workflow_dispatch` runs selected a tag on the then-current `main`, passed source and product checks, signed and notarized their DMGs, deployed the app-owned Worker, verified the live download bytes, and committed the site manifest to `main`. PerformanceDaddy, BrowserDaddy, and ContextDaddy also published GitHub releases from the qualified artifacts. The three live Sparkle feeds advertise the builds below. The listed SHA-256 values were independently checked against fresh `/download` responses after each successful run.

| App | Exact release source and protected run | Public release and live DMG SHA-256 |
| --- | --- | --- |
| StorageDaddy | `cf8c8cdfa6df05b212e43d233f5cd8a1cf8927e8` · [run 36180923620](https://github.com/sarthakagrawal927/storagedaddy/actions/runs/36180923620) | `v0.1.3-110` · [download](https://storage.daddyrad.com/download) · [Sparkle feed](https://storage.daddyrad.com/updates/appcast.xml) · `d2e0109d189869d6425d8c30d50ca1e3365c3b66ec76270f3fdedbedffa4baee` |
| PerformanceDaddy | `0c541aa03249c746615875f2af0d3f4379ee422b` · [run 36183263765](https://github.com/sarthakagrawal927/performancedaddy/actions/runs/36183263765) | [`v0.2.3-8`](https://github.com/sarthakagrawal927/performancedaddy/releases/tag/v0.2.3-8) · [download](https://performance.daddyrad.com/download) · [Sparkle feed](https://performance.daddyrad.com/updates/appcast.xml) · `97f91011f7c1791090e4a35459df20168ca00b091db975a602039f878a1907fb` |
| BrowserDaddy | `9a1768666072ee87d261b777e5fcf055117cbc6d` · [run 36183142078](https://github.com/sarthakagrawal927/browserdaddy/actions/runs/36183142078) | [`v0.3.1-9`](https://github.com/sarthakagrawal927/browserdaddy/releases/tag/v0.3.1-9) · [download](https://browser.daddyrad.com/download) · [Sparkle feed](https://browser.daddyrad.com/updates/appcast.xml) · `017c8eb5f92dcacdf2e5ede3ade4c3f159658739df0f2774f6b894855fad676f` |
| ContextDaddy | `108f33636cb7e9a6fc87f3e5423805f9484c5b04` · [run 36183267447](https://github.com/sarthakagrawal927/contextdaddy/actions/runs/36183267447) | [`v0.1.0-5`](https://github.com/sarthakagrawal927/contextdaddy/releases/tag/v0.1.0-5) · [download](https://context.daddyrad.com/download) · `899470dcad266ad80859cdb16a3f95a88cf40c0c1bbcfe06e91c4c41f2391299` |

The first manual attempts exposed missing protected Cloudflare inputs, a feed working-directory bug, a fixed-filename site test, a narrower Cloudflare token that could upload assets but not complete Wrangler deployment, and a GitHub release command without an explicit repository. The app fixes [StorageDaddy #46](https://github.com/sarthakagrawal927/storagedaddy/pull/46), [PerformanceDaddy #12](https://github.com/sarthakagrawal927/performancedaddy/pull/12) and [#13](https://github.com/sarthakagrawal927/performancedaddy/pull/13), [BrowserDaddy #16](https://github.com/sarthakagrawal927/browserdaddy/pull/16) and [#17](https://github.com/sarthakagrawal927/browserdaddy/pull/17), and [ContextDaddy #7](https://github.com/sarthakagrawal927/contextdaddy/pull/7) and [#8](https://github.com/sarthakagrawal927/contextdaddy/pull/8) are merged. The corrected protected runs above are green. The new builds have public byte and release-job receipts; isolated installed-app acceptance remains the separate observation recorded for the September 25 builds.
